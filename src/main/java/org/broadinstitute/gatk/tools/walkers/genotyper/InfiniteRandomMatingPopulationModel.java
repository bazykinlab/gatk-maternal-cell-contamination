...
public class InfiniteRandomMatingPopulationModel implements GenotypingModel {
    ...
    public <A extends Allele> GenotypingLikelihoods<A> calculateLikelihoods(final AlleleList<A> genotypingAlleles, final GenotypingData<A> data) {
        ...
        System.out.println("calculateLikelihoods, sampleCount = " + sampleCount);
        System.out.println("calculateLikelihoods, permutation = " + permutation);
        System.out.println("calculateLikelihoods, alleleLikelihoodMatrixMapper = " + alleleLikelihoodMatrixMapper);
        switch (sampleCount) {
